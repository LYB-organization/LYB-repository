...
import com.rainbow.common.factory.ExcelWriterFactory;
import com.rainbow.common.handler.WriterHandler07;
import com.rainbow.listener.ExcelListener;
...
public class ExcelUtil {
     ...
     */
    public static <T extends BaseRowModel> void writeExcel(HttpServletResponse response, List<T> list, String fileName, String sheetName, ExcelTypeEnum excelTypeEnum, Class<T> classType)  throws ExcelException{
